<template>
  <div id="topbar">
    ...
    <Dialog title="注册" v-bind:visible="signUpDialogVisible" v-on:close="signUpDialogVisible = false">
      <SignUpForm v-on:success="signIn($event)"></SignUpForm>
    </Dialog>

    <Dialog title="登录" v-bind:visible="signInDialogVisible" v-on:close="signInDialogVisible=false">
